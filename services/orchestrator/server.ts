    ...
    if (
      ...
      json(response, 200, {
        ...
        detail: {
          ...
          plannerLane: detail.plannerLane,
          leadLanes: detail.leadLanes,
          integratorLane: detail.integratorLane,
          adoptedPlan: detail.adoptedPlan,
          currentWaveId: detail.currentWaveId,
          dispatchQueue: detail.dispatchQueue,
          queueStatus: detail.queueStatus,
          replan: detail.replan,
          replanHistory: detail.replanHistory,
          links: detail.links,
        },
      });
      return;
