...
export function getSessionControlPath(sessionId) {
  return path.join(PROJECT_ROOT, "tmp", "sessions", `${sessionId}.control.ndjson`);
}
...
export async function readControlMessagesFromOffset(controlPathOrSessionId, offset = 0) {
